      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
        <div>
          ...
          <p className="text-gray-600 mb-4">
            ...
            jewelry, but we&apos;ve never lost sight of our roots. Every piece we create
            is still handcrafted with the same attention to detail and passion that Maria
            brought to her work over three decades ago.
          </p>
          <p className="text-gray-600">
            Today, we&apos;re proud to serve customers around the world while maintaining
            our commitment to quality, craftsmanship, and ethical sourcing.
          </p>
        </div>
